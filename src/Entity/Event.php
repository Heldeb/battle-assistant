...
class Event
{
    ...
    #[ORM\ManyToOne(inversedBy: 'organisation')]
    private ?User $organisation = null;

    /**
     * @var Collection<int, User>
     */
    #[ORM\ManyToMany(targetEntity: User::class, inversedBy: 'organization')]
    ...
    public function getOrganisation(): ?User
    {
        return $this->organisation;
    }

    public function setOrganisation(?User $organisation): static
    {
